                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="result.php" method="post">
                            ...
                            How <b>frequently </b> do you want to pay?
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="gridRadios" id="monthlyRadio"
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="gridRadios" id="yearlyRadio"
                                    value="yearly">
